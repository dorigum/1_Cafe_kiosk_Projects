...
public class MenuRepositoryImpl implements MenuRepository {
	...
	public List<Menu> getAllMenus() {
		...
		try (Connection conn = DBUtil.getConnection();
			...
			while (rs.next()) {
				Menu menu = new Menu(rs.getLong("menu_id"), rs.getInt("category_id"), rs.getString("category_name"),
						rs.getString("menu_name"), rs.getInt("price"), rs.getString("description"),
						rs.getBoolean("is_available"), rs.getTimestamp("created_at"));
	...
	public Menu findById(long id) {
		...
		try (Connection conn = DBUtil.getConnection(); PreparedStatement pstmt = conn.prepareStatement(sql)) {
			...
			try (ResultSet rs = pstmt.executeQuery()) {
				if (rs.next()) {
					Menu menu = new Menu(rs.getLong("menu_id"), rs.getInt("category_id"),
